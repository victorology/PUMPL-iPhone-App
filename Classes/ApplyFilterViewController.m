...
- (void)buildFilterButtonScrollView
{
	...
	UIButton *normalButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonXCoordinate + normalLabel.frame.origin.x,
																		...
																		kFilterButtonSide,
																		kFilterButtonSide)];
	[normalButton setImage:[UIImage imageNamed:@"whiteButton.png"] forState:UIControlStateNormal];
	...
	UIButton *xProButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonXCoordinate + xProLabel.frame.origin.x,
																		...
																		kFilterButtonSide,
																		kFilterButtonSide)];
	[xProButton setImage:[UIImage imageNamed:@"whiteButton.png"] forState:UIControlStateNormal];
	...
	UIButton *vintageButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonXCoordinate + vintageLabel.frame.origin.x,
																	  ...
																	  kFilterButtonSide,
																	  kFilterButtonSide)];
	[vintageButton setImage:[UIImage imageNamed:@"whiteButton.png"] forState:UIControlStateNormal];
	...
	UIButton *lomoButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonXCoordinate + lomoLabel.frame.origin.x,
																		 ...
																		 kFilterButtonSide,
																		 kFilterButtonSide)];
	[lomoButton setImage:[UIImage imageNamed:@"whiteButton.png"] forState:UIControlStateNormal];
	...
	UILabel *photochromeLabel = [[UILabel alloc] initWithFrame:CGRectMake((4 * (kPaddingBetweenFilterButtons + kFilterLabelWidth)),
																   ...
																   kFilterLabelWidth,
																   kFilterLabelHeight)];
	photochromeLabel.text = @"Photochrome";
	...
	UIButton *photochromeButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonXCoordinate + photochromeLabel.frame.origin.x,
																	  ...
																	  kFilterButtonSide,
																	  kFilterButtonSide)];
	[photochromeButton setImage:[UIImage imageNamed:@"whiteButton.png"] forState:UIControlStateNormal];
	...
	UIButton *monochromeButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonXCoordinate + monochromeLabel.frame.origin.x,
																			 ...
																			 kFilterButtonSide,
																			 kFilterButtonSide)];
	[monochromeButton setImage:[UIImage imageNamed:@"whiteButton.png"] forState:UIControlStateNormal];
