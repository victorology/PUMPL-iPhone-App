...
- (void)buildTableData
{
	...
	[row1 setValue:@"Username" forKey:@"inputName"];
...
- (void)requestFinished:(ASIHTTPRequest *)request
{
	...
	if(code == 0)
	{
		...
		{
			UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Congratulations" message:@"You have successfully logged into your twitter account." delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
			alertView.tag = 1;
			[alertView show];
			[alertView release];
		}
