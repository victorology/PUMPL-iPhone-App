...
@implementation HomeScreenDataSource
...
- (NSString *)titleAtIndex:(NSInteger)index
{
	...
	if(index == 2)
	{
		return @"This is the title for 3rd photo";
	}
	else if(index == 3)
	{
		return @"This is the title for 4th photo and it si a bit lengthy title and hopefull things will go fine.";
	}
		
	return [NSString stringWithFormat:@"Hello - %d",index];
	 */
	
	if([titles_ count] > index)
